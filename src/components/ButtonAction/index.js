...
import './index.scss'
const Button = ({product,handleAdd}) => {
    ...
    return (
        <div>
            <div className={'wrapper-buttons'}>
                ...
                <button>
                    <svg  onClick={() => setIsFavorite(!isFavorite)} width="23" height="21" viewBox="0 0 23 21" fill={isFavorite ? "tomato" : "none"} xmlns="http://www.w3.org/2000/svg">
